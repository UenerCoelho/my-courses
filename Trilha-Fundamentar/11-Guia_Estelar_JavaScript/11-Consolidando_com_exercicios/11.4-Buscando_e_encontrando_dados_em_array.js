console.log(`Aula 11.4-Buscando_e_encontrando_dados_em_array
...
/*
    ...
    Baseado no Array de Livros por Categorias abaixo, faça os seguintes Desafios
        ...
        • Transformar a função acima em uma função que irá receber o nome di autor e
...
const booksByCategory = [
  {
    ...
    books: [
      ...
      {
        title: "O homem mais rica da Babilônia",
